...
from agentarts.wrapper.mcpgateway.mcp_gateway_client import MCPGatewayClient
from agentarts.wrapper.service.http_client import RequestConfig, RequestResult
...
class TestMCPGatewayClient:
    ...
    @patch('agentarts.wrapper.mcpgateway.mcp_gateway_client.MCPGatewayClient.post')
    ...
    @patch('agentarts.wrapper.mcpgateway.mcp_gateway_client.MCPGatewayClient.put')
    ...
    @patch('agentarts.wrapper.mcpgateway.mcp_gateway_client.MCPGatewayClient.delete')
    ...
    @patch('agentarts.wrapper.mcpgateway.mcp_gateway_client.MCPGatewayClient.get')
