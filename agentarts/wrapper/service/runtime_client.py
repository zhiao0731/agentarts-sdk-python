...
Usage::
    ...
    from agentarts.wrapper.service import RuntimeClient
...
from agentarts.wrapper.service.http_client import BaseHTTPClient, RequestConfig, RequestResult
...
class RuntimeClient(BaseHTTPClient):
    ...
    Args:
        control_endpoint: Override the control plane base URL.
            ...
            via :func:`~agentarts.wrapper.utils.constant.get_control_plane_endpoint`.
        data_endpoint: Override the data plane base URL.
            If ``None``, the URL is derived from environment variables
            via :func:`~agentarts.wrapper.utils.constant.get_data_plane_endpoint`.
    ...
    # ================================================================
    # Control Plane – Agent Endpoint APIs
    # ================================================================
    ...
    def invoke_agent(
        ...
        **extra: Any,
        ...
        """
        from agentarts.wrapper.runtime.model import SESSION_HEADER
